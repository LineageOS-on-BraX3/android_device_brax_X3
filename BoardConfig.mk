...
BOARD_VENDOR_KERNEL_MODULES += \
    ...
    $(BOARD_KERNEL_MODULE_DIR)/wlan_drv_gen4m_6835.ko \
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 238479704064

-include vendor/lineage/config/BoardConfigReservedSize.mk

BOARD_SUPER_PARTITION_GROUPS := mediatek_dynamic_partitions
BOARD_SUPER_PARTITION_SIZE := 9663676416
BOARD_MEDIATEK_DYNAMIC_PARTITIONS_PARTITION_LIST := system product system_ext vendor system_dlkm vendor_dlkm odm_dlkm
...
# WiFi
HOSTAPD_CUSTOM_DEF_CONFIG_FILE_PATH := $(DEVICE_PATH)/configs/wifi/hostapd.android.config
SUPPLICANT_CUSTOM_DEF_CONFIG_FILE_PATH := $(DEVICE_PATH)/configs/wifi/supplicant.android.config
...
include vendor/brax/X3/BoardConfigVendor.mk
